...
execute store result storage apocalypse_light:detect difficulty short 1 run difficulty
execute if data storage apocalypse_light:detect {difficulty:0s} run scoreboard players reset @a
execute if data storage apocalypse_light:detect {difficulty:2s} run scoreboard players add @a zombie_limit 100
execute if data storage apocalypse_light:detect {difficulty:3s} run scoreboard players add @a zombie_limit 200
execute if data storage apocalypse_light:detect {difficulty:1s} as @e[type=zombie] run attribute @s minecraft:generic.movement_speed base set 0.18
execute if data storage apocalypse_light:detect {difficulty:2s} as @e[type=zombie] run attribute @s minecraft:generic.movement_speed base set 0.23
execute if data storage apocalypse_light:detect {difficulty:3s} as @e[type=zombie] run attribute @s minecraft:generic.movement_speed base set 0.3
